...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x6000_POT_VALUE = 0x00000000,
    .x6001_WIPER_SPEED_r = 0x00000000
};
...
typedef struct {
    ...
    OD_obj_var_t o_6000_POT_VALUE;
    OD_obj_var_t o_6001_WIPER_SPEED_r;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_6000_POT_VALUE = {
        .dataOrig = &OD_PERSIST_COMM.x6000_POT_VALUE,
        .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
        .dataLength = 4
    },
    .o_6001_WIPER_SPEED_r = {
        .dataOrig = &OD_PERSIST_COMM.x6001_WIPER_SPEED_r,
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6000, 0x01, ODT_VAR, &ODObjs.o_6000_POT_VALUE, NULL},
    {0x6001, 0x01, ODT_VAR, &ODObjs.o_6001_WIPER_SPEED_r, NULL},
